...
/*   Updated: 2016/05/23 17:30:07 by eozdek           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	SDL_QueryTexture(sdl->texPlay[i][nb], NULL, NULL, &sdl->rectPlayer[i][nb].w, &sdl->rectPlayer[i][nb].h);
	sdl->rectPlayer[i][nb].x = sdl->solidRect.x - 50;
